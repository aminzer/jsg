(function () {
    ...
    var ObjectMap = function () {
        ...
        self.prototype._add = function (el, processed_mirror_chain) {
            ...
            if (this._mirror_for_adding && !~processed_mirror_chain.indexOf(this._mirror_for_adding)) {
                processed_mirror_chain.push(this);
                this._mirror_for_adding._add(el, processed_mirror_chain);
            }
        };
        ...
        self.prototype._remove = function (id, processed_mirror_chain) {
            if (this.contains(id)) {
                delete this._map[id];
                if (this._mirror_for_removing && !~processed_mirror_chain.indexOf(this._mirror_for_removing)) {
                    processed_mirror_chain.push(this);
                    this._mirror_for_removing._remove(id, processed_mirror_chain);
                }
            }
        };
        ...
        self.prototype.set_mirror_for_adding = function (mirror_for_adding) {
            this._mirror_for_adding = mirror_for_adding;
        };

        self.prototype.set_mirror_for_removing = function (mirror_for_removing) {
