define(function (require, exports, module) {
    ...
    var MathUtil = {
        ...
        /**
         * return sin of angle in degress
         * @param degreeAngle
         * @returns {number}
         */
        sin_d: function (degreeAngle) {
            return Math.sin(Math.PI / 180 * degreeAngle)
        },

        /**
         * return cos of angle in degress
         * @param degreeAngle
         * @returns {number}
         */
        cos_d: function (degreeAngle) {
            return Math.cos(Math.PI / 180 * degreeAngle)
        },
        ...
        /**
         * return true if point (x,y) is in rectangle (rectX0, rectY0, rectX1, rectY1)
         */
        isInRectangle: function (x, y, rectX0, rectY0, rectX1, rectY1) {
            return this.isBetween(x, rectX0, rectX1) && this.isBetween(y, rectY0, rectY1);
        },
